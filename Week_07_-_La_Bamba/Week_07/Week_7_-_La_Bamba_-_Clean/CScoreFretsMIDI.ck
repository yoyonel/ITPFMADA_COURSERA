...
public class CScoreFretsMIDI
{
    ...
    480 => int TPQ;
    0::second => dur tick_duration;
    0 => int nb_samp_for_1_tick;
    0::second => dur step_time_for_ChucK;
    0 => int cur_tick;
    ...
    {
        0 => cur_counter_duration[i] => cur_midi[i] => cur_fret[i] => cur_string[i];
