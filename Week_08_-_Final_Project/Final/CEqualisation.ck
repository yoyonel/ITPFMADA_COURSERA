...
{
	// Sound chain
	// master: gain, manage volume in equalisation
	// fades_inout: manage fades in-out in equalisation
	Gain master => ADSR fades_inout => dac;
	...
	// Sound chain
	// pan: manage panoramic in equalisation
	Pan2 pan => master;		
