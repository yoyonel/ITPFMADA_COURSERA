// Assignment_1_MeloDramaTick_Heart_Song_no_functions_no_array_no_fx
// Autor : ???
// Date : 2013-10-25


// Libraries using in this 'project':
// - Math: cos, sin, min, max, sqrt, atan2
// - Std: rand2f
...
6 => int osc1_nb_tones_in_scale;    // 6 = 75% of 8 tones (ps: some groove is here !)
...
while(time_current_length_song <= time_max_length_song)
{
    ...
    //osc2_func_heart_indice + osc2_func_heart_inc_indice*(0.1*Std.rand2f(0.25, 1.0)) => float osc2_t_add_delay;
    ...
    //Math.sin(osc2_t) * pi => float osc2_func_heart_t;	
